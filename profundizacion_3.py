...
print()
print("Ingrese su nombre completo y presione Enter")
nombre_completo1=str(input())
print()
print("Su nombre utilizando el metodo lower es:", nombre_completo1.lower())
print("Su nombre utilizando el metodo upper es:", nombre_completo1.upper())
print("Su nombre utilizando el metodo capitalize es:", nombre_completo1.capitalize())
print("Su nombre utilizando el metodo title es:", nombre_completo1.title())
print()
